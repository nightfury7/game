                     ...
                     int x4, int y4, int vx4, int vy4)
{
    ...
    while (true)
    {
        ...
        int dist13 = sqrt ((x3 - x1) * (x3 - x1) + (y3 - y1) * (y3 - y1));

        int dist14 = sqrt ((x4 - x1) * (x4 - x1) + (y4 - y1) * (y4 - y1));

        int dist23 = sqrt ((x3 - x2) * (x3 - x2) + (y3 - y2) * (y3 - y2));

        int dist24 = sqrt ((x4 - x2) * (x4 - x2) + (y4 - y2) * (y4 - y2));
